...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Building p_Building;
        ...
        public static SteamVR_Input_ActionSet_Building Building
        {
            get
            {
                return SteamVR_Actions.p_Building.GetCopy<SteamVR_Input_ActionSet_Building>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Building = ((SteamVR_Input_ActionSet_Building)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Building>("/actions/Building")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Building};
        }
    }
}
